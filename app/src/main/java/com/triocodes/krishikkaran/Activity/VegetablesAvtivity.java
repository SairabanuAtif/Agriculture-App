...
public class VegetablesAvtivity extends ParentActivity implements VolleyCallback, Response.ErrorListener,Response.Listener {
    Toolbar mToolbar;
    ...
    ListView mListView;
    LinearLayout mLayoutNoVegetables;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vegetables_avtivity);
        ...
        mListView = (ListView) this.findViewById(R.id.list_vegetable);
        mLayoutNoVegetables=(LinearLayout)this.findViewById(R.id.layout_no_vegetables);
        mLayoutNoVegetables.setVisibility(View.GONE);
    ...
    private void passData() {
        try {
            ...
            mVegetableDetails.put("CategoryID", "1");
            mVegetableDetails.put("CountFrom",x);
            mVegetableDetails.put("CountTo",y);

            super.showProgress("Please Wait");
            establishConnection(Request.Method.POST, Constants.mVegetablesUrl, mVegetableDetails);
        } catch (Exception e) {
            ...
            public void run() {
                if (!extras.isEmpty()) {
                    try {
                        ...
                        handleVegetablesList(responseType);
                    } catch (Exception e) {
    ...
    private void handleVegetablesList(String responseType) {
        try {
        ...
        try {
            if (List != null && List.size() > 0) {
                ...
                mListView.setSelection(totalItem);//totalItem
                ...
                mLayoutNoVegetables.setVisibility(View.VISIBLE);
            }
        } catch (Exception e) {
